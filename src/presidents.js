...
const presidentNames = getNames(presidents);
...
const democraticPresidents = getDemocraticPresidents(prsidents);
...
const totalYearsServed = countYearsInOffice(presidents);
console.log(totalYearsServed);
